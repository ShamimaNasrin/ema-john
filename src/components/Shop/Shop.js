...
const Shop = () => {
    ...
    }, [page, size]);//data will load whwnever the value of page and size will change
    ...
    return (
        <div className='shop-container'>
            ...
            <div className="pagination">
                ...
                {/* how many data want to load in a page(size) */}
                <select onChange={event => setSize(event.target.value)}>
                    <option value="5">5</option>
                    <option value="10" select="true">10</option>
